<div align="center">
  <img src="https://cdn-icons-png.flaticon.com/512/3514/3514491.png" alt="Bazario Logo" width="80" />
  <h1>Bazario - Full-Stack MERN E-Commerce App</h1>
...
MONGO_URI=mongodb://127.0.0.1:27017/Bazario
JWT_SECRET=super_secret_key
RAZORPAY_KEY_ID=your_key_id
RAZORPAY_KEY_SECRET=your_key_secret
```

From the **root folder** `Bazario/`, trigger a full install across environments:
```bash
npm run build
```
...
npm run seed
```
> **Seed Admin Access:** Email: `admin@Bazario.com` | Password: `password123`
...
This repository includes a fully-scaffolded API testing toolkit: **`Bazario_Postman_Collection.json`**. 
